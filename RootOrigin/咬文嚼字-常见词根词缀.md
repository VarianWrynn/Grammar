...
| poet-ic                                           | 诗的，诗意的，诗人的                                         | **Meta-phys-ic-s**                              <br />【ˌmetəˈfɪzɪks】 | **`meta-`**在后/在..之上 + **`phys-`**物理 + **`-ic`**表形容词.<br />形而上学：the branch of philosophy that deals with the nature of existence, truth and knowledge |
...
| ac-cumul-ate<br />【əˈkjuːmjəleɪt】                          | 积累;积聚;(数量)逐渐增加;(数额)逐渐增长                      | na-rr-ate<br />【ˈnæreɪt】      | **`na-`**=gno-知道 + -**`r(r)`**拉丁语现在不定式格 + **`-ate`**, 表动，词引申词义叙述，告知。 |
