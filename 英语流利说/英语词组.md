...
- in a certain interval of time ==> [at certain intervals](https://messagemedia.com/au/blog/what-are-webhooks/) （每隔一定时间）
...
- **fits and starts**:  If something happens in fits and starts, it often stops and then starts again. （**间歇地；一阵一阵地**)

  -  Right now, the software industry has been in [a nearly two-decade economic boom](https://www.economist.com/leaders/2020/02/20/how-to-make-sense-of-the-latest-tech-surge) (with [some fits and starts](https://nolanlawson.com/2022/06/09/the-collapse-of-complex-software/)), but the one sure thing in economics is that booms eventually turn to busts. 

- **contract**: 既可以表示合同，也可以表示收缩：**con-共同 + tract-拉 → 共同拉[回去] → 收缩;对大家都有制约 → 合同**。

  >  con-,表强调，-tract,拉，拉紧，词源同 attract,traction.引申词义确立条款，签订合同。

  - During the boom, software companies can keep hiring new headcount to manage their existing software (i.e. more engineers to understand more boxes and arrows), but if their labor force is forced to [contract](https://nolanlawson.com/2022/06/09/the-collapse-of-complex-software/), then that same system may become unmaintainable
...
- **at all cost**: A software company that values growth [at all cost](https://nolanlawson.com/2022/06/09/the-collapse-of-complex-software/), like the Romans eagerly gobbling up more and more of Gaul, will likely fall into the “add-complexity-and-collapse” cycle.
- 
